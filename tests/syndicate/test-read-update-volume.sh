...
$SYNDICATE_TOOL -c "$CONFIG_PATH" update_volume "$RANDOM_VOLUME_NAME" description="foo" private=False file_quota=123456
RC=$?
...
VOLUME_JSON="$($SYNDICATE_TOOL -c "$CONFIG_PATH" read_volume "$RANDOM_VOLUME_NAME")"
RC=$?
