...
setup(name='syndicate',
      ...
      package_dir={
                ...
                'syndicate.rg.drivers.dropbox': os.path.join(ext_source_root, build_dir, 'syndicate/rg/drivers/dropbox'),
      ...
      package_data={
                ...
                'syndicate.rg.drivers.dropbox': make_driver_paths('syndicate/rg/drivers/dropbox'),
