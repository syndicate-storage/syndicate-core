...
def get_bucket(bucket_name):
    try:
        ...
        if(DEBUG):
            log.debug(u'ERROR: Connection to %s failed', RG_STORE)
    else:
        if(DEBUG):
            log.debug(u'ERROR: Connected to %s', RG_STORE)
    ...
    try:
        ...
        if(DEBUG):
            log.debug(u'ERROR: Could not create/fetch bucket: %s', bucket_name)
        return False

    if(DEBUG):
        log.debug(u'Fetched/created bucket: %s', folder_metadata)
...
def write_file(file_name):
    if(DEBUG):
        log.debug(u'Writing file: %s', file_name)
    ...
    if(DEBUG):
        log.debug(u'Written file to %s', RG_STORE)
...
def read_file(file_name):
    if(DEBUG):
        log.debug(u'Reading file: %s', file_name)
    ...
    if(DEBUG):
        log.debug(u'Read data from %s: %s', RG_STORE, metadata)
...
def delete_file(file_name, bucket_name):
    if(DEBUG):
        log.debug(u'Deleting file: %s', file_name)
    ...
    if(DEBUG):
        log.debug(u'Deleted %s file: %s', RG_STORE, file_name)
