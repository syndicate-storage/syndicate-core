...
def write_file(file_name, bucket_name):
    ...
    if(DEBUG):
        print 'Written file to GS: "%s/%s"' % (dst_uri.bucket_name, dst_uri.object_name)
...
def delete_file(file_name, bucket_name):
    if(DEBUG):
        print "Deleting File: " + bucket_name + '/' + file_name
    ...
    if(DEBUG):
        print "Deleted GS file: " + bucket_name + '/' + file_name
